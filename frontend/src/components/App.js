...
function App() {
  ...
  // Коммент от Ревьюера (Roland Sallatc) 17.07.2023
  // При входе в аккаунт стоит записывать емейл пользователя в стейт,
  // иначе он загружается только после перезагрузки страницы
  // Авторизация
